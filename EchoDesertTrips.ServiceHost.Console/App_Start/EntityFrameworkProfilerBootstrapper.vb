...
<assembly: WebActivatorEx.PreApplicationStartMethod(GetType(Global.EchoDesertTrips.ServiceHost.Console.App_Start.EntityFrameworkProfilerBootstrapper), "PreStart")>
Namespace App_Start
